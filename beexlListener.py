...
class beexlListener(ParseTreeListener):
    ...
    Listener used by Antlr4 parser.

    Occurs when the parser enters or exists a rule in the tree produced by the Beexl Parsere
    ...
    # Enter a parse tree produced by beexlParser#ArrayAssign0.
    def enterArrayAssign0(self, ctx:beexlParser.ArrayAssign0Context):
    ...
    # Enter a parse tree produced by beexlParser#ArrayAssign1.
    def enterArrayAssign1(self, ctx:beexlParser.ArrayAssign1Context):
        beexlSemantic.operandDepth += 1
    
    # Enter a parse tree produced by beexlParser#ArrayExpCall0.
    ...
    # Enter a parse tree produced by beexlParser#ArrayExpCall1.
    def enterArrayExpCall1(self,ctx:beexlParser.ArrayExpCall1Context):
        beexlSemantic.operandDepth += 1

    # Enter a parse tree produced by beexlParser#ArrayInit0.
    ...
    # Enter a parse tree produced by beexlParser#Await0.
    def enterAwait0(self,ctx:beexlParser.Await0Context):
        beexlSemantic.addQuadruple(["await",int(ctx.getText().split('await')[1][:-1])])
  
    # Exit a parse tree produced by beexlParser#ArrayAssign1.
    def exitArrayAssign1(self, ctx:beexlParser.ArrayAssign1Context):
    ...
    # Exit a parse tree produced by beexlParser#ArrayAssign21.
    def exitArrayAssign2(self,ctx:beexlParser.ArrayAssign2Context):
        result = beexlSemantic.operandStack[1][0]
        var_info = beexlSemantic.operandStack[0][0]
        beexlSemantic.addQuadruple(['=p',result,var_info])

    # Exit a parse tree produced by beexlParser#ArrayExpCall1.
    ...
    # Enter a parse tree produced by beexlParser#ExpresionRestart0.
    ...
    # Exit a parse tree produced by beexlParser#ExpresionRestart0.
    ...
    # Enter a parse tree produced by beexlParser#functionCall2.
    def enterFunctionCall2(self,ctx:beexlParser.FunctionCall2Context):
        beexlSemantic.param_index += 1

    # Enter a parse tree produced by beexlParser#functionCallFactor0.
    ...
    # Exit a parse tree sproduced by beexlParser#functionCall0.
    ...
    # Exit a parse tree sproduced by beexlParser#functionDefinition3.
    def exitFunctionDefinition3(self, ctx:beexlParser.FunctionDefinition3Context):
        beexlSemantic.addQuadruple(["ENDFUNC"])

    # Exit a parse tree sproduced by beexlParser#functionCallFactor0.
    ...
    # Enter a parse tree produced by beexlParser#return0.
    ...
    # Exit a parse tree produced by beexlParser#return0.
    ...
    # Enter a parse tree produced by beexlParser#showCanvas0.
    def enterShowCanvas0(self, ctx:beexlParser.ShowCanvas0Context):
        beexlSemantic.addQuadruple(['SHOW_CANVAS'])
    
    # Enter a parse tree produced by beexlParser#showCanvasChanges0.
    ...
    # Enter a parse tree produced by beexlParser#term1.
