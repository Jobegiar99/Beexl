...
class VirtualMachine:
    """
    This class contains the code for the virtual machine
    it will read the quadruples generated by the compiler.

    Each function corresponds to a quadruple's command and some may be
    a helper of the quadruple command's function.
    ...
    This function helps to obtain the value of a memory direction
    or just return the given value if it is already an integer or float.
    
    Also helps to obtain the value of a memory address to which a pointer
    is pointing to.
